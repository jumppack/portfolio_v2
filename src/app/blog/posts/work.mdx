...
You can use custom components in MDX files, but you need to import them first in the `src/components/CustomMDX.tsx` file.
...
<CodeBlock
  ...
  codes={[
    ...
    CodeBlock,
      ...
      language: "tsx",
      label: "src/components/CustomMDX.tsx",
    },
  ]}
/>
